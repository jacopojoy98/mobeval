...
|:-------------|-----------------:|-------------:|-------------:|-----------:|-----------:|
| KinematicRef |              9   |         -0.7 |         97.1 |       -4   |       20.3 |
| WeakRef      |             19.5 |        -74.1 |        nan   |        1.6 |     -100   |

## Efficiency (Pareto front)

| model        |   mean_skill |   n_parameters |   latency_ms | pareto_optimal   |
|:-------------|-------------:|---------------:|-------------:|:-----------------|
| KinematicRef |     0.243364 |            352 |   0.694151   | True             |
| WeakRef      |    -0.382486 |              5 |   0.00452207 | True             |
...
| ('mode/linear_probe@1 · accuracy ↑ (fraction)', 'linear_probe')            | 0.739 [-13%]           | n/a            | 0.769                       |              0.59   |
| ('mode/linear_probe@1 · balanced_accuracy ↑ (fraction)', 'linear_probe')   | 0.584 [+5%]            | n/a            | 0.564                       |              0.25   |
| ('mode/linear_probe@1 · cls_nll ↓ (nats)', 'linear_probe')                 | 0.59 [Δ+0.76]          | n/a            | 1.35                        |              0.942  |
| ('mode/linear_probe@1 · ece ↓ (fraction)', 'linear_probe')                 | 0.0649 [+64%]          | n/a            | 0.179                       |              0.0612 |
| ('mode/linear_probe@1 · macro_f1 ↑ (fraction)', 'linear_probe')            | 0.558 [-8%]            | n/a            | 0.589                       |              0.185  |
...
| ('mode/native@1 · accuracy ↑ (fraction)', 'native')                        | n/a                    | 0.619 [-65%]   | 0.769                       |              0.59   |
| ('mode/native@1 · balanced_accuracy ↑ (fraction)', 'native')               | n/a                    | 0.769 [+47%]   | 0.564                       |              0.25   |
| ('mode/native@1 · cls_nll ↓ (nats)', 'native')                             | n/a                    | 0.906 [Δ+0.45] | 1.35                        |              0.942  |
| ('mode/native@1 · ece ↓ (fraction)', 'native')                             | n/a                    | 0.114 [+37%]   | 0.179                       |              0.0612 |
| ('mode/native@1 · macro_f1 ↑ (fraction)', 'native')                        | n/a                    | 0.529 [-15%]   | 0.589                       |              0.185  |
...
| ('efficiency/continuous/duration · latency_ms_per_sample ↓ (ms)', 'native')    | 0.0013         | 0.000315  |
| ('efficiency/continuous/travel_time · latency_ms_per_sample ↓ (ms)', 'native') | 0.002          | 0.000422  |
| ('efficiency/embedding · latency_ms_per_sample ↓ (ms)', 'native')              | 0.0551         | n/a       |
| ('efficiency/generation · latency_ms_per_sample ↓ (ms)', 'native')             | 3.71           | n/a       |
| ('efficiency/mode_classification · latency_ms_per_sample ↓ (ms)', 'native')    | n/a            | 0.00907   |
| ('efficiency/next_location · latency_ms_per_sample ↓ (ms)', 'native')          | 0.0517         | 0.000805  |
| ('efficiency/recovery · latency_ms_per_sample ↓ (ms)', 'native')               | 0.348          | 0.012     |
